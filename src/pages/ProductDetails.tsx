...
const ProductDetails = ({ name, price, imgURL }) => {
  return (
    <div className="max-container p- my-2 transition duration-500 ease-in-out shadow-2xl  bg-zinc-400 cursor-pointer rounded-2xl transform hover:scale-110 hover:shadow-[0_0_50px_orange]">    
